...
const BaiTap3 = () => {
  ...
  const handleSlide = () => {
    ...
    const listUploadedClientWidth = listUploadedRef.current?.offsetWidth;
    const fileUploadedWidth = fileUploadedRef.current?.offsetWidth;

    console.log(listUploadedRef.current?.offsetWidth);
    const removeSpace = listUploadedOffsetWidth- 
