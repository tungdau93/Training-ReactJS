...
const hideListItem = (e)=>{
    const showList = document.querySelector(".app__container--input-wrapper--dropdown-list")
    if(!showList.is(e.target) && container.has(e.target).length === 0){
      container.hide();
  }
}
        ...
        <div className="app__container">
          ...
          <div className="app__container--input-wrapper">
            ...
            <input
              ...
              onClickOutside ={hideListItem}
              type="text"
              placeholder="Nhập tên thành phố để tìm kiếm..."
              className="app__container--input-wrapper--input"
            ></input>
            <div onMouseUp ={hideListItem} className="app__container--input-wrapper--dropdown-list">
