...
const BaiTap3 = () => {
  ...
  const handleSlide = () => {
    ...
    if (listUploadedRef.current && fileUploadedRef.current) {
      let scrollTo = 0;
      console.log("listUploadedScroll", listUploadedScroll);
      console.log("listUploadedOffsetWidth", listUploadedOffsetWidth);
      console.log("listUploadedClientWidth", (fileUploadedWidth + 2) * 5);
      if (
        listUploadedOffsetWidth + listUploadedScroll <
        (fileUploadedWidth + 2) * 5
      ) {
        scrollTo = listUploadedScroll + fileUploadedWidth + 2;
      } else {
        console.log()
        scrollTo = (fileUploadedWidth + 2) * 5;
      }
