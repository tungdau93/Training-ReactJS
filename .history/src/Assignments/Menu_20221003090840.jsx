...
const Menu = () => {
  ...
  return (
    <div>
      <ul style={styleUl}>
        <li style={{listStyleType:'none'}} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} onClick={() => redirectPage("/")}>
          <div style={styleHomePage}>HomePage</div>
        </li>
        <li style={{listStyleType:'none'}}  onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} onClick={() => redirectPage("/bai-tap-2")}>
          <div >Bài tập 2</div>
        </li>
