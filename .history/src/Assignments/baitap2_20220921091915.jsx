      ...
      <div className="app">
        ...
        <div className="app__container">
          ...
          <div className ="app__container--input-wrapper" >
            <div className ="app__container--input-wrapper--group">
              <span><FontAwesomeIcon icon="fa-thin fa-magnifying-glass" /></span>
               <input type="text" placeholder="Nhập tên thành phố để tìm kiêms" className ="app__container--input-wrapper--input" ></input>
            </div>
