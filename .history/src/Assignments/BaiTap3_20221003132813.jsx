      ...
      <div className="show-data">
        <div className="show-data-list">
          <div className="show-data-list-item">
            ...
            <img className="item-label--close-button" src={require("../assets/images/close-button.png")}></img>
          </div>
          <div className="show-data-list-item">
            <img
              className="image-item"
            ...
            <img src={require("../assets/images/close-button.png")}></img>
          </div>
          <div className="show-data-list-item">
            <img
              className="image-item"
