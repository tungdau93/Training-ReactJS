...
const PersonalInfoForm = (props) => {
  ...
  const handleCLickJobs = (codeJob) =>{
    setForm({ ...form, codeJob });
    const jobChosen = findCity(codeJob);
    const newJobsTag = [...jobTags]
    newJobsTag.push(jobChosen);
    console.log(newJobsTag);
  ...
  const handleClickCities = (codeCity) => {
    setForm({ ...form, codeCity });
    const cityChosen = findCity(codeCity);
  ...
  const findJobs = (code) => {
    if (code) {
      return jobs.find((item) => item && item?.code === code);
    }
    return {};
  };
    ...
    <div className="form-personal-info">
      ...
      <div className="body">
        ...
        <div  ref={searchRef} className="form-input form-job-position">
          ...
          <input onFocus={handleJobFocus} className="job-position-input" type="text" />
          {
            isJobSearchActive?
            
          <div className="job-option-wrap">
              {
                jobPosition.map((job) => {
                  return (
                    <div
        ...
        >
          <div className={isImgSelected?"hide-drag-and-drop-label":"drag-and-drop-label"}>
            ...
            <img className={isImgSelected?"image-selected":"hide-drag-and-drop-label"}  src={file}/>
          <input
