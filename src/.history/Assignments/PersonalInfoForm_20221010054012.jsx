      ...
      <div className="body">
        ...
        <div ref={searchRef} className="form-input form-city">
          ...
          <input
            ...
            onFocus={handleFocus}
          />
          <div className={isShowCitiesTag?"cities-tag":null}>{
            citiesTag.length> 0 && citiesTag.map((cityTag)=>{
              return(<div className="cities-tag-container">
                <span key={cityTag.code}>
                  {cityTag.name}
                </span>
                <img className="close-img" src={require("../assets/images/close-button.png")} />
              </div>
              )
